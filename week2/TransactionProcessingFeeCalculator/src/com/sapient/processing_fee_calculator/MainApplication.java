...
import com.sapient.processing_fee_calculator.RW.CSVReader;
import com.sapient.processing_fee_calculator.RW.CSVWriter;
import com.sapient.processing_fee_calculator.RW.RecordsReader;
import com.sapient.processing_fee_calculator.RW.ReportGenerator;
import com.sapient.processing_fee_calculator.Transactions.PriorityFlag;
import com.sapient.processing_fee_calculator.Transactions.Transaction;
import com.sapient.processing_fee_calculator.Transactions.TransactionType;
...
public class MainApplication {
	...
	static {
		recordsReader = new CSVReader();
		reportGenerator = new CSVWriter();
	}
	...
	public static void main(String[] args) {
		...
		String outputFilename = "SummaryReport.csv";
